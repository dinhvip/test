...
const Memo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
  ...
  >
    ...
    <path
      d="M29.549 10.6651L28.5568 9.67399C27.9561 9.07206 26.9811 9.07328 26.3792 9.67399L25.4519 10.6025L28.6207 13.7712L29.5489 12.8438C30.1498 12.242 30.1498 11.267 29.5489 10.6651H29.549Z"
      fill="#FF963C"
    />
    <path
